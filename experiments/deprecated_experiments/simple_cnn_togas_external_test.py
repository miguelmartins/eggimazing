...
def main():
    ...
    X, y = df_ipo['image_directory'], df_ipo['eggim_square']
    ...
    tf_train_df = get_tf_eggim_patch_dataset(df_ipo.loc[train_idx], num_classes=3)
    tf_val_df = get_tf_eggim_patch_dataset(df_ipo.loc[internal_val_idx], num_classes=3)
